...
namespace DesafioBackend.Mottu.Migrations
{
    ...
    [Migration("20240325123450_Motorcycle_Rental_and_Delivery_Person")]
    partial class Motorcycle_Rental_and_Delivery_Person
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DesafioBackend.Mottu.Entities.DeliveryPersons.DeliveryPerson", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CnhImageType")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("MottuTablesDeliveryPersons", (string)null);
                });

            modelBuilder.Entity("DesafioBackend.Mottu.Entities.Motorcycles.Motorcycle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MottuTablesMotorcycles", (string)null);
                });

            modelBuilder.Entity("DesafioBackend.Mottu.Entities.MotorcyclesRental.MotorcycleRental", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MottuTablesMotorcycleRentals", (string)null);
                });
            ...
            modelBuilder.Entity("Order", b =>
                {
                    ...
                    b.ToTable("MottuTablesOrders", (string)null);
                });
            ...
            modelBuilder.Entity("Order", b =>
                {
                    b.HasOne("DesafioBackend.Mottu.Entities.DeliveryPersons.DeliveryPerson", "DeliveryPerson")
                        .WithMany("Orders")
